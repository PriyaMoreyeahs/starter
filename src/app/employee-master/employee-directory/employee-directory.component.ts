...
export class EmployeeDirectoryComponent implements OnInit {
  ...
  empdirectoryfilteradmin() {
    ...
    this.employeeService.empdirectoryfilteradmin(post).subscribe((res: any) => {
  ...
  getallactiveorg() {
    this.organizationService.getallactiveorg('').subscribe((res: any) => {
  ...
  getallactivedesignation() {
    this.organizationService.getallactivedesignation().subscribe((res: any) => {
  ...
  getuserlogintype() {
    this.organizationService.getuserlogintype().subscribe((res: any) => {
