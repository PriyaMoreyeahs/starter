...
export class EmployeeService {
  ...
  getnewemployeeonboarding(post) {
    return this.http.post(`${this.API}/api/newemployeeservice/getnewemployeeonboarding`, post)
  }
  //#endregion

  //#region api to get employee
  empdirectoryfilter(data) {
    return this.http.post(`${this.API}/api/employeenew/empdirectoryfilter`, data);
  }
  //#endregion

  //#region api to lock the credentionls of the employee
  lockemployee(id) {
    return this.http.post(`${this.API}/api/employeenew/lockemployee?employeeId=${id}`, id);
  }
  //#endregion

  //#region api to create the employee for onbording
  createemployeeentity(post) {
    return this.http.post(`${this.API}/api/newemployeeservice/createemployeeentity`, post);
  }
  //#endregion

  //#region function to update the employee
  updatenewemployee(post) {
    return this.http.post(`${this.API}/api/newemployeeservice/updatenewemployee`, post)
  }
  //#endregion

  //#region api to update the employee onbording process
  updatenewemployeeonboarding(post) {
    return this.http.post(`${this.API}/api/newemployeeservice/updatenewemployeeonboarding`, post)
  }
  //#endregion

  //#region api to get the information of employee using employee id
  getnewemployeebyid(employeeId) {
    return this.http.get(`${this.API}/api/newemployeeservice/getnewemployeebyid?employeeId=${employeeId}`)
  }
  //#endregion

  //#region api to get the information of employee on the onbording stage
  getnewemployeeonboardingbyid(employeeId) {
    return this.http.get(`${this.API}/api/newemployeeservice/getnewemployeeonboardingbyid?employeeId=${employeeId}`)
  }
  //#endregion
  ...
  emplistnotself(empId) {
    return this.http.get(`${this.API}/api/employeenew/emplistnotself?employeeId=${empId}`);
  }
  //#endregion
  ...
  empdirectoryfilteradmin(data) {
    return this.http.post(`${this.API}/api/employeenew/empdirectoryfilteradmin`, data);
  }
