...
export class DepartmentComponent implements OnInit {
  ...
  getdepartmentonadmin() {
    ...
    this.organizationService.getdepartmentonadmin(post).subscribe((res: any) => {
      this.departmentInformation = this.CRUDFunction.responceBindingInPagination(res);
  ...
  addUpdateDepartmentPopUp(addUpdateDepartmentComponent, id?) {
    ...
    this.popupFunctionService.poupOpenFunction(addUpdateDepartmentComponent, 'lg');
  }
  //#endregion
  ...
  submitValue(value) {
    let apiName = ''
    this.departmentId ? (apiName = 'updatedepartment', value['departmentId'] = this.departmentId) : apiName = 'createdepartment';
    this.organizationService[apiName](value).subscribe((res: any) => {
      this.CRUDFunction.apiResponce(res, 'Department') ? this.getdepartmentonadmin() : '';
    }, (err: any) => {
  ...
  deleteDepartment(departmentId) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        this.organizationService.deletedepartment(departmentId).subscribe((data: any) => {
          if (data.status) {
            Swal.fire(
              "Deleted!",
