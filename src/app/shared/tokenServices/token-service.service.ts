import { HttpBackend, HttpErrorResponse, HttpHeaders, HttpRequest } from '@angular/common/http';
...
export class TokenServiceService {
  ...
  constructor(private router: Router, private authenticationService: AuthService, private httpBackend: HttpBackend
  ) {
  ...
  errorhandle(req, next, url) {
    ...
    this.httpBackend
      .handle(new HttpRequest('GET', `${this.baseURl}/api/isamanager/getnewtsfaccesstoken`, { headers: header }))
      .subscribe((res: any) => {
