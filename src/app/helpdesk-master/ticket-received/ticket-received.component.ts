...
export class TicketReceivedComponent implements OnInit {
  ...
  openTicketList: any = [];
  closeTicketList: any = [];
  configTicketRecivedOpen: { itemsPerPage: number; currentPage: number; id: string; totalItems: string; };
  configTicketRecivedClose: { itemsPerPage: number; currentPage: number; id: string; totalItems: string; };

  constructor(private CRUDFunction: CRUDFunction, private ticketService: TicketService) {
  ...
  openticket() {
    ...
    this.ticketService.openticket(post).subscribe((res: any) => {      let responce = this.CRUDFunction.responceBindingAsObject(res);
  ...
  closeticket() {
    ...
    this.ticketService.closeticket(post).subscribe((res: any) => {      let responce = this.CRUDFunction.responceBindingAsObject(res);
