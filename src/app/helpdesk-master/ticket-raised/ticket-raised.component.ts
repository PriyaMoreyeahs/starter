...
export class TicketRaisedComponent implements OnInit {
  ...
  configTicketRaisedOpen: { itemsPerPage: number; currentPage: number; id: string; };
  configTicketRaisedClose: { itemsPerPage: number; currentPage: number; id: string; };
  openTicketList: any = [];
  tableResponce: any;
  closeTicketList: any = [];

  constructor(private toastrService: ToastrService, private popupFunctionService: PopupFunctionService, private CRUDFunction: CRUDFunction, private ticketService: TicketService, private formBuilder: FormBuilder) {
  ...
  getallcategorys() {
    this.ticketService.getallcategorys().subscribe((res: any) => {
  ...
  submitTicket(value) {
    this.submitted = true;
    this.CRUDFunction.checkValidation(value) ? this.submitFunction(value.value) : '';
  }
  submitFunction(value) {
    ...
    this.ticketService.createticket(value).subscribe((res: any) => {
  ...
  ticketsraised() {
    this.ticketService.ticketsraised().subscribe((res: any) => {      this.tableResponce = this.CRUDFunction.responceBindingAsObject(res);
