...
export class TicketService {
  ...
  getallticketcategory(value) {
    return this.http.get(`${this.API}/api/newticketcategory/getallticketcategory?active=${value}`);
  }
  //#endregion
  ...
  createcategory(data) {
    return this.http.post(`${this.API}/api/newticketcategory/createcategory`, data);
  }
  //#endregion

  //#region api to get the ticket category data using tocket category id
  getticketcategorybyid(categoryId) {
    return this.http.get(`${this.API}/api/newticketcategory/getticketcategorybyid?categoryId=${categoryId}`);
  }
  //#endregion

  //#region update ticekt category
  updatecategory(data) {
    return this.http.post(`${this.API}/api/newticketcategory/updatecategory`, data);
  }
  //#endregion
  ...
  getallsubcategorybyid(categoryId) {
    return this.http.get(`${this.API}/api/newticketcategory/getallsubcategorybyid?categoryId=${categoryId}`);
  }
  //#endregion

  //#region api to get the priorities in the ticket category
  getallprioritiesbyid(id) {
    return this.http.get(`${this.API}/api/newticketcategory/getallprioritiesbyid?categoryId=${id}`);
  }
  //#endregion

  //#region api to upload the files while creating the ticket
  uploadticketmultiple(post) {
    return this.http.post(`${this.API}/api/ticketmaster/uploadticketmultiple`, post)
  }
  //#endregion
  ...
  getticketdetails(ticketId) {
    return this.http.get(`${this.API}/api/ticket/getticketdetails?ticketId=${ticketId}`);
  }
  //#endregion
  ...
  ticketcategoryidemp(categoryId) {
    return this.http.get(`${this.API}/api/ticket/ticketcategoryidemp?ticketCategoryId=${categoryId}`);
  }
  //#endregion
